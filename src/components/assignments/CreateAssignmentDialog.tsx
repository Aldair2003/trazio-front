  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => {
      ...
      <DialogTrigger asChild>
        <Button className="w-full sm:w-auto bg-green-100 hover:bg-green-200 dark:bg-green-900/30 dark:hover:bg-green-900/50 text-green-700 dark:text-green-300">
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[85vh] overflow-hidden p-0">
        {/* Header mejorado */}
        <div className="bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/20 dark:to-emerald-800/20 px-6 pt-6 pb-8">
          <DialogHeader>
            <div className="flex items-start gap-4">
              <div className="p-3 bg-green-100 dark:bg-green-900/30 rounded-2xl border border-green-200 dark:border-green-800">
                <ClipboardList className="h-7 w-7 text-green-600 dark:text-green-400" />
              </div>
              <div className="flex-1">
                <DialogTitle className="text-2xl font-bold text-green-900 dark:text-green-100 mb-1">
                  Documentar Tarea
                </DialogTitle>
                <p className="text-sm text-green-700 dark:text-green-300">
                  Registra tu trabajo y comparte con tu comunidad
                </p>
              </div>
            </div>
          </DialogHeader>
        ...
        <div className="px-6 py-6 overflow-y-auto max-h-[calc(85vh-140px)]">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2.5">
              ...
              >
                <SelectTrigger className="h-12 border-2 hover:border-emerald-300 transition-colors">
              ...
              {selectedSubject?.teacher && (
                <div className="flex items-center gap-2 text-xs text-muted-foreground bg-emerald-50 dark:bg-emerald-950/30 px-3 py-2.5 rounded-lg border border-emerald-100 dark:border-emerald-900">
            ...
            <div className="space-y-2.5">
              ...
              <Input
                ...
                className="h-12 border-2 hover:border-emerald-300 transition-colors"
                {...register('title')}
                disabled={isLoading}
              />
              {errors.title && (
            ...
            {/* Fecha de Entrega */}
            <div className="space-y-2.5">
              <Label htmlFor="dueDate" className="flex items-center gap-2 text-sm font-semibold">
            ...
            <div className="space-y-2.5">
              <Label htmlFor="githubLink" className="flex items-center gap-2 text-sm font-semibold">
                ...
                Link de GitHub <span className="text-muted-foreground font-normal">(opcional)</span>
              </Label>
              <Input
                id="githubLink"
            ...
            <div className="space-y-2.5">
              ...
              <Textarea
                ...
                className="min-h-[100px] resize-none border-2 hover:border-emerald-300 transition-colors"
            ...
            <div className="space-y-3">
              ...
              <div 
                ...
                className="border-2 border-dashed border-emerald-200 dark:border-emerald-900 rounded-xl p-8 text-center cursor-pointer hover:border-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 transition-all duration-200"
              >
                {isUploading ? (
                  <div className="flex flex-col items-center gap-3">
                    <Loader2 className="h-10 w-10 animate-spin text-emerald-600" />
                    <p className="text-sm font-medium text-emerald-600">Subiendo archivos...</p>
                  </div>
                ) : (
                  <div className="flex flex-col items-center gap-3">
                    <div className="p-4 bg-emerald-100 dark:bg-emerald-950 rounded-2xl">
                ...
                <div className="space-y-3 mt-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {uploadedFiles.map((file) => (
                      <div 
                        key={file.publicId}
                        className="relative group rounded-xl border border-emerald-100 dark:border-emerald-900 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 overflow-hidden"
                      >
            ...
            <div className="flex gap-3 pt-6">
              ...
              <Button 
                ...
                className="flex-1 h-11 bg-green-100 hover:bg-green-200 dark:bg-green-900/30 dark:hover:bg-green-900/50 text-green-700 dark:text-green-300 font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
              >
